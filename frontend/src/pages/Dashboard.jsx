  ...
  return (
    <div className="animate-up" style={{ padding: '4rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem' }}>Welcome back, <span style={{ color: 'var(--primary)' }}>{user?.name}</span></h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
        ...
        <StatCard 
          ...
          value={stats.totalArticles * 10 + stats.totalLikes} 
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
        <div className="glass-card" style={{ padding: '2rem' }}>
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <Clock size={20} /> Your Recent Contributions
          </h2>
          {recentArticles.length === 0 ? (
            <p style={{ color: 'var(--text-secondary)' }}>You haven't published any articles yet.</p>
          ) : (
        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <Link to="/create-article" className="btn btn-primary" style={{ justifyContent: 'center' }}>Create New Article</Link>
            <Link to="/articles" className="btn btn-outline" style={{ justifyContent: 'center' }}>Browse Repository</Link>
            <Link to="/profile" className="btn btn-outline" style={{ justifyContent: 'center' }}>Manage Profile</Link>
          </div>
          
          <div style={{ marginTop: '2.5rem', padding: '1.5rem', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '12px' }}>
            <h4 style={{ marginBottom: '0.5rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Pro Tip:</h4>
            <p style={{ fontSize: '0.85rem' }}>Articles with visuals and clear headings receive 40% more engagement on average.</p>
          </div>
        </div>
      </div>
    </div>
